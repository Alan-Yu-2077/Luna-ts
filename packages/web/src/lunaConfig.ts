...
// LUNA_TTS_BACKEND / LUNA_TTS_URL / LUNA_UI_MODE). Absent in a plain browser, so every field is
// optional and every reader falls back to a localStorage override or a default.
